...
//   Widget _buildNameOfDayCard(AppProvider appProvider, bool isDark) {
//     // Deterministic "Name of the Day" based on day of year
//     final now = DateTime.now();
//     final startOfYear = DateTime(now.year, 1, 1);
//     final dayOfYear = now.difference(startOfYear).inDays; // 0-based
...
//                       color: appProvider.accentColor.withOpacity(0.18),
...
//               _buildNameOfDayCard(appProvider, isDark),
